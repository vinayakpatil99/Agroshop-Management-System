    ...
    <style media="screen">
        * {
        ...
        button:hover {
            ...
            color: #ffffff;
            box-shadow: 0px 4px 15px rgba(35, 162, 246, 0.4);
        }

        /* Click animation effect */
        button:active {
            transform: scale(0.98);
            box-shadow: 0px 2px 10px rgba(35, 162, 246, 0.5);
        }
...
<body>
   ...
   <form action="AdminLoginServlet" method="POST">
    ...
    <!-- Back to Home button -->
    <button type="button" onclick="window.location.href='index.html'" style="margin-top: 20px; background-color: #ff512f; color: #ffffff;">
        Back to Home
    </button>
</form>


        <!-- Login button with interactive animation -->
